...
HELP_MESSAGE = """👋 Hey there! Are you ready to get the most out of our Telegram bot powered by OpenAI GPT-3.5-Turbo? Here are some commands to help you get started:

⚪ /retry – Feeling unsure about the last response? Use this to regenerate it!
⚪ /new – Want to start a new conversation? Use this command to reset the chat.
⚪ /mode – Choose your chat mode! You can switch to special modes like "Code Assistant" or "Writing Assistant".
⚪ /balance – Curious about your balance? Use this command to check it out.
⚪ /help – Need more assistance? Use this command to see this message again.

We hope these commands help you make the most of our bot's features! If you have any questions or issues, our friendly support team is always here to help. Let's start chatting! 🤖💬
"""
